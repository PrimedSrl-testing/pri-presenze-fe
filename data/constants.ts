...
export const CAUSALI_ASSENZA: CausaleAssenza[] = [
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  dip: { vede_propria_scheda: true, richiede_ferie: true, vede_cedolino: true },
  mgr: { vede_team: true, approva_ferie: true, vede_presenze_team: true, segnala_anomalie: true },
  hr:  { gestisce_dipendenti: true, modifica_contratti: true, chiude_mese: true, export_paghe: true, vede_tutto: true },
  dir: { vede_dashboard_dir: true, vede_kpi: true, vede_costi: true },
};

export const MESI_STATO_DEFAULT: Record<string, { stato: string; chiuso_da: string | null; chiuso_il: string | null }> = {
