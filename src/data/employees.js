// client/src/data/employees.js
// ─────────────────────────────────────────────────────────────
// Dataset dipendenti PRIMED estratto dall'applicazione originale.
// In produzione: sostituire con chiamata API GET /api/employees
// ─────────────────────────────────────────────────────────────
...
/** Helper: trova dipendente per matricola */
export const findByMat = (mat) => EMPLOYEES.find(e => e.mat === mat);

/** Helper: dipendenti attivi */
export const getActive = () => EMPLOYEES.filter(e => e.active && e.status === 'IN');

/** Helper: dipendenti per reparto */
export const getByDept = (dept) => EMPLOYEES.filter(e => e.dept === dept);
