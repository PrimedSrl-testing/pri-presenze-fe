...
| PRES-002 | 2026-09-16 | Nunzia Convertini | Contratto ciclico, tipologie contratto, conteggio 24/12 mesi | IN ATTESA |
...
- **Aperta:** 2026-09-16 · **Stato:** IN ATTESA (due chiarimenti chiesti a Nunzia + approccio da approvare con Alberto)
...
**Chiarimenti chiesti a Nunzia (2026-09-16 14:05, nel thread):**

1. Nel riquadro *Programma*: casella da spuntare a mano, oppure compilazione automatica leggendo il *Contratto Ciclico* già configurato più in basso? E conferma che le ore devono cambiare da sole al cambio di periodo.
2. Elenco definitivo delle tipologie: *A tempo determinato*, *A tempo indeterminato*, *Tirocinio*, *Altro* — ne mancano?
